...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  let total = 0;
  for (index = 0; index <= resultadosTest.length - 1; index++) {
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  let valorMasGrande = numeros[0];
  for (var input = 1; input < numeros.length; input++) {
    if (numeros[input] > valorMasGrande) {
      valorMasGrande = numeros[input];
    }
  }
...
function cuentoElementos(arreglo) {
  ...
  for (let index = 0; index < arreglo.length; index++) {
    if (arreglo[index] > 18) {
      elementosMayores18.push(arreglo[index]);
      mayor18 = mayor18 + 1;
    }
  }
  return mayor18;
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  numeroASting = n.toString();
  if (numeroASting.charAt(0) == "9") {
    return true;
  } else {
    return false;
  }
